...
public struct V3StopGeosearch: Codable {
    ...
    public init(disruptionIds: [Int64]?, stopDistance: Float?, stopSuburb: String?, stopName: String?, stopId: Int?, routeType: Int?, stopLatitude: Float?, stopLongitude: Float?, stopSequence: Int?) {
